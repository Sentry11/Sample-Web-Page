...
import defaultCardImage from "../temp/shield-icon.svg";
...
import FastIconImage from "../temp/fast-icon.svg";
import ReliableIconImage from "../temp/reliable-icon.svg";
import SimpleIconImage from "../temp/simple-icon.svg";



const Container = tw.div`relative bg-white -mx-8 px-8 text-black`;
