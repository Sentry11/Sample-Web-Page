...
const Input = tw.input`mt-6 first:mt-0 rounded-lg  py-3 font-medium  border-gray-100 pl-1`
const Textarea = styled(Input).attrs({as: "textarea"})`
  ${tw`h-24 mt-8 border-gray-400 rounded-lg pt-2 pl-1`}
`
...
const Contact = ({
  ...
  heading = <>Feel free to <span tw="text-[#724C9D]">get in touch</span><wbr/> with us.</>,
  ...
  return (
    <Container>
      ...
      <TwoColumn>
        <ImageColumn>
          <Image imageSrc="https://www.comsyscx.com/wp-content/uploads/2019/04/contact-page-banner.png" />
        </ImageColumn>
