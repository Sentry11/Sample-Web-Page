...
const Card = styled.a`
  ${tw`flex flex-col items-center text-center h-full mx-4 px-4 py-8 rounded transition-transform duration-300 hover:text-black hover:pointer-events-none   text-black `}
  .imageContainer {
  ...
  .link {
    ${tw`mt-auto inline-flex items-center pt-5 text-sm font-bold text-black leading-none hocus:text-gray-700 transition duration-300`}
    .icon {
      ${tw`ml-2 w-4`}
    }
  }
