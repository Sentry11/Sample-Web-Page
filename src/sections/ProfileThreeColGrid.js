...
const CardContent = styled.div`
  ...
  .position {
    ${tw`uppercase font-bold tracking-widest text-xs text-[#2C1B47]`}
  }
  .name {
    ${tw`mt-1 text-xl font-medium text-black`}
  9
`
...
const CardLinks = styled.div`
  ${tw`mt-6 flex`}
  .link {
    ${tw`mr-8 last:mr-0 text-[#9356A0] hocus:text-[#2C1B47] transition duration-300`}
    .icon {
